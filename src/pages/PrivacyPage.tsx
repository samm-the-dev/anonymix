  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8 text-sm text-foreground [&_h1]:mb-4 [&_h1]:font-display [&_h1]:text-2xl [&_h1]:font-bold [&_h2]:mb-3 [&_h2]:mt-8 [&_h2]:font-display [&_h2]:text-xl [&_h2]:font-semibold [&_h3]:mb-2 [&_h3]:mt-6 [&_h3]:font-display [&_h3]:text-lg [&_h3]:font-semibold [&_h4]:mb-2 [&_h4]:mt-4 [&_h4]:font-semibold [&_p]:mb-3 [&_p]:leading-relaxed [&_p]:text-muted-foreground [&_ul]:mb-3 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:text-muted-foreground [&_li]:mb-1 [&_strong]:text-foreground [&_a]:text-primary [&_a]:underline">
      ...
      <ul>
        ...
        <li><p><strong>Application</strong> refers to Anonymix, the software program provided by the Company.</p></li>
        <li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Anonymix.</p></li>
      ...
      <ul>
        ...
        <li><p><strong>For other purposes</strong>: We may use Your information for other purposes, such as data analysis, identifying usage trends, and to evaluate and improve our Service, products, services, and your experience.</p></li>
      </ul>
      ...
      <p>Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of Our Service, or We are legally obligated to retain this data for longer time periods.</p>
