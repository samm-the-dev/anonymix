export function TermsPage() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-8 text-sm text-foreground [&_h1]:mb-4 [&_h1]:font-display [&_h1]:text-2xl [&_h1]:font-bold [&_h2]:mb-3 [&_h2]:mt-8 [&_h2]:font-display [&_h2]:text-xl [&_h2]:font-semibold [&_h3]:mb-2 [&_h3]:mt-6 [&_h3]:font-display [&_h3]:text-lg [&_h3]:font-semibold [&_p]:mb-3 [&_p]:leading-relaxed [&_p]:text-muted-foreground [&_ul]:mb-3 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:text-muted-foreground [&_li]:mb-1 [&_strong]:text-foreground [&_a]:text-primary [&_a]:underline">
      ...
      <ul>
        <li><p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Anonymix</p></li>
        ...
        <li><p><strong>Country</strong> refers to: Texas, United States</p></li>
        <li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to Anonymix.</p></li>
        ...
        <li><p><strong>Website</strong> refers to Anonymix, accessible from <a href="https://anonymix.app">https://anonymix.app</a></p></li>
      ...
      <ul>
        <li>By email: hello@samm-the.dev</li>
      </ul>
    </div>
  );
}
